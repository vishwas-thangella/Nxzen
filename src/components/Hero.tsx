...
import nxgen from "../assets/nxgen.jpeg";
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-10 flex justify-center">
            <motion.img
              src={nxgen}
              alt="Nxgen Logo"
              className="w-20 h-32 sm:w-40 sm:h-40 object-cover border-4 border-purple-500 shadow-lg shadow-purple-500/40"
          ...
          {/* Title */}
          <motion.h1
            className="text-5xl md:text-7xl mb-6 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent font-bold"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Join Nxzen's national hackathon to design data-driven, AI-powered
            utilities that make cities efficient, sustainable, and
            consumer-friendly.
          </motion.p>
